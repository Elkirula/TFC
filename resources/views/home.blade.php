  ...
  <div class="db-wrapper">
      ...
      <div class="container" >
        <div class="row">
          <div class="col-8">
            ...
            <a href="https://eventmie-pro-fullyloaded-demo.classiebit.com/events" class="btn btn-sm text-primary mt-lg-2 float-end">View All <i class="fas fa-arrow-right"></i></a>
          </div>      
      </div> 
    ...
    <div class="py5">
      <div class="container" >
        ...
        <div class="row justify-content-center">
            <!-- Gallery item -->
            <div class="col-xl-3 col-lg-4 col-md-6 mb-4" style="width: 438px;">
              <div class="bg-white rounded">
                <div class="p-4">
                  <div class="article-card">
                    <div class="content">
